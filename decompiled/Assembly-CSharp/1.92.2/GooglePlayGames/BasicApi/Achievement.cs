...
namespace GooglePlayGames.BasicApi
{
  public class Achievement
  {
    ...
    {
      return string.Format("[Achievement] id={0}, name={1}, desc={2}, type={3}, revealed={4}, unlocked={5}, steps={6}/{7}", (object) this.mId, (object) this.mName, (object) this.mDescription, (object) (!this.mIsIncremental ? "STANDARD" : "INCREMENTAL"), (object) this.mIsRevealed, (object) this.mIsUnlocked, (object) this.mCurrentSteps, (object) this.mTotalSteps);
    }
  }
}
