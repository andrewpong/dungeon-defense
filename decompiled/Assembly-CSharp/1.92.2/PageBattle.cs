...
public class PageBattle : UIMgr
{
  ...
  protected override void Start()
  {
    ...
    var bSpeedFactor = (!Info.option.bDoubleSpeed ? 1 : 2);
    var eleHasteFactor = (double) Info.GetElementalFac(ElementalID.eFireHaste, 0) * 0.01;
    var partyHasteFactor = (double) Info.GetPartySkillFac(SkillKey.eHaste) * 0.01;

    Time.timeScale = (float) (bSpeedFactor * (1 + eleHasteFactor + partyHasteFactor));
